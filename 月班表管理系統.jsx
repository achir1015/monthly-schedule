 ...
 */
// React Hooks 由全域 React 物件取得（供 Babel standalone 使用）
    ...
    <div style={card}>
      ...
      <div style={{ marginBottom: 12 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 8, alignItems: "center" }}>
          <span style={{ fontSize: 17, color: "#6b7280", marginRight: 2 }}>班別：</span>
          {shiftDefs.map((s) => (
            <span key={s.code} style={{
              padding: "2px 10px", borderRadius: 4, fontSize: 17, fontWeight: 500,
        ...
        <div style={{
          ...
          <span style={{ fontSize: 17, color: "#1d4ed8" }}>
            ✏️ <strong>如何修改班別：</strong>
          </span>
          <span style={{ fontSize: 17, color: "#1d4ed8" }}>
            點擊任意<strong>班別格子</strong>
          </span>
          <span style={{ fontSize: 17, color: "#6b7280" }}>→</span>
          <span style={{ fontSize: 17, color: "#1d4ed8" }}>
          ...
          {editing && (
            <span style={{
              ...
              fontSize: 17, color: "#1e40af", fontWeight: 500,
            }}>
      ...
      <div style={{ overflowX: "auto" }}>
        <table style={{ borderCollapse: "collapse", fontSize: 17 }}>
          {/* 欄寬設定 */}
          <colgroup>
            ...
            {employees.flatMap((emp, ri) => {
              ...
              rows.push(
                <tr key={emp.id} style={{ background: rowBg }}>
                  ...
                  >
                    <div style={{ fontWeight: 500, color: "#1f2937", fontSize: 18 }}>
                      {emp.name}
                    </div>
                    <div style={{ fontSize: 14, color: "#9ca3af" }}>{emp.id}</div>
                  </td>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={card}>
        ...
        <div style={{ overflowX: "auto" }}>
          <table
            style={{ width: "100%", borderCollapse: "collapse", fontSize: 18 }}
          >
            <thead>
              <tr>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 12 }}>
          {shiftDefs.map((st) => (
            ...
            >
              ...
              <div style={{ fontSize: 17, color: "#6b7280" }}>{st.name}</div>
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
        <span style={{
          ...
          borderRadius: 6, padding: "3px 10px", fontSize: 17, fontWeight: 700,
        }}>PDF 轉入</span>
        <h3 style={{ margin: 0, fontSize: 21, fontWeight: 500, color: "#4c1d95" }}>
          PDF 班表匯入
        </h3>
      </div>
      <p style={{ margin: "0 0 14px", fontSize: 18, color: "#6d28d9", lineHeight: 1.6 }}>
        ...
        <div>
          ...
          {showPaste && (
            <div style={{
              ...
              <p style={{ margin: "0 0 8px", fontSize: 17, color: "#6b7280" }}>
          ...
          {phase === "error" && (
            <div style={{
              ...
              fontSize: 18, color: "#b91c1c", whiteSpace: "pre-line",
              lineHeight: 1.7,
            }}>
              ✗ {errMsg}
            </div>
      ...
      {phase === "preview" && preview && (
        <div>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontSize: 15, color: "#7c3aed" }}>辨識月份</div>
              <div style={{ fontSize: 24, fontWeight: 700, color: "#4c1d95" }}>
                民國 {preview.year - 1911} 年 {preview.month} 月
              </div>
              <div style={{ fontSize: 15, color: "#8b5cf6" }}>西元 {preview.year} 年</div>
            </div>
            <div>
              <div style={{ fontSize: 15, color: "#7c3aed" }}>辨識員工數</div>
              <div style={{ fontSize: 24, fontWeight: 700, color: "#4c1d95" }}>
                {Object.keys(preview.empMap).length} 人
              </div>
            </div>
            <div>
              <div style={{ fontSize: 15, color: "#7c3aed" }}>月份天數</div>
              <div style={{ fontSize: 24, fontWeight: 700, color: "#4c1d95" }}>
                {preview.days} 天
              </div>
            </div>
            ...
            {previewHasOld && (
              <div style={{
                ...
                fontSize: 18, color: "#92400e", fontWeight: 500,
                lineHeight: 1.5,
              }}>
                ⚠ 此月份已有班表資料<br/>
                ...
                {Object.entries(preview.empMap).map(([id, shifts], ri) => (
                  <tr key={id} style={{
                    ...
                    <td style={{
                      ...
                      {empName(id)}{" "}
                      <span style={{ color: "#a78bfa", fontWeight: 400, fontSize: 14 }}>
                        {id}
                      </span>
                    </td>
                    {shifts.map((sh, di) => {
      ...
      {phase === "done" && (
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{
            ...
            borderRadius: 6, fontSize: 18, color: "#15803d",
          }}>
      ...
      <div style={card}>
        ...
        >
          {[
            ...
            >
              <div
                style={{ fontSize: 31, fontWeight: 500, color: "#1b6ca8" }}
              >
                {value}
              </div>
              <div
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div style={{
        ...
        fontSize: 17, color: "#1d4ed8", lineHeight: 1.8,
      }}>
      ...
      <div style={{ ...card, padding: "12px 16px" }}>
        ...
        <select
          ...
          style={{
            ...
            border: "1px solid #d1d5db", fontSize: 21,
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 3, marginBottom: 4 }}>
          {WEEKDAY.map((w, i) => (
            <div
              key={w}
              style={{
                textAlign: "center", fontSize: 17, fontWeight: 500, padding: "4px 0",
      ...
      {editing !== null && emp && (
        <div style={{ ...card, background: "#eff6ff", border: "1px solid #bfdbfe" }}>
          <div style={{ fontSize: 18, color: "#1d4ed8", fontWeight: 500, marginBottom: 8 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
            ...
            <button
              ...
              style={{
                ...
                background: "#f9fafb", color: "#6b7280", fontSize: 20,
                cursor: "pointer", fontFamily: "inherit",
              }}
            >
              清除
            ...
            <button
              ...
              style={{
                padding: "8px 14px", border: "1px solid #d1d5db", borderRadius: 6,
                background: "#fff", color: "#9ca3af", fontSize: 20,
                cursor: "pointer", fontFamily: "inherit",
              }}
            >
              取消
      ...
      {/* ── 當月出勤統計 ── */}
      <div style={card}>
        <div style={{ fontSize: 18, color: "#6b7280", marginBottom: 10 }}>
          {emp?.name} 本月出勤統計
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8 }}>
          {[
            ...
            >
              <div style={{ fontSize: 31, fontWeight: 700, color }}>{cnt[code]}</div>
              <div style={{ fontSize: 15, color: "#9ca3af", marginTop: 3 }}>{label}</div>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        {/* 系統標題 */}
        <div>
          <div style={{ fontSize: 22, fontWeight: 500, letterSpacing: 0.5 }}>
            月班表管理系統
          </div>
          <div style={{ fontSize: 15, opacity: 0.75, marginTop: 2 }}>
            呼吸照護病房（RCW）・病房助理
          </div>
        </div>
